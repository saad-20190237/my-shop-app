...
export default function App() {
  ...
  const userRole = localStorage.getItem("userRole"); // 👈 نقرأ الـ role
  ...
  const handleAdd = async (p: Product) => {
    ...
    try {
      ...
      console.error(e);
      const msg =
        e?.response?.data || e?.message || "Failed to add to cart";
